...
```{r}
dataOlympics <- read_csv("/Users/tanushree/Desktop/Projects/DV Project/datasets/athleteEvents.csv", col_types = cols(
                   ID = col_character(),
                   Name = col_character(),
...
NOCs <- read_csv("/Users/tanushree/Desktop/Projects/DV Project/datasets/nocRegions.csv", col_types = cols(
                  NOC = col_character(),
...
medalCounts <- medalCounts %>% dplyr::select( Medal, Team, Count)
medalCounts
```
