...
dataOlympics <- read_csv("/Users/tanushree/Desktop/Projects/FDA PROJECT/PROJECT/Team - T/datasets/athleteEvents.csv", col_types = cols(
                   ID = col_character(),
                   Name = col_character(),
...
NOCs <- read_csv("/Users/tanushree/Desktop/Projects/FDA PROJECT/PROJECT/Team - T/datasets/nocRegions.csv", col_types = cols(
                  NOC = col_character(),
